...
def get_extensions_in_pack(pack_name: str) -> list[str]:
    packs = {
        ...
        'universalomega': ['AutoCreatePage', 'DiscordNotifications', 'DynamicPageList4', 'PortableInfobox', 'Preloader', 'SimpleBlogPage', 'SimpleTooltip'],
        'wikitide': ['CreateWiki', 'DataDump', 'GlobalNewFiles', 'ImportDump', 'IncidentReporting', 'ManageWiki', 'MatomoAnalytics', 'MirahezeMagic', 'PDFEmbed', 'RemovePII', 'RequestCustomDomain', 'RottenLinks', 'WikiDiscover'],
    }
